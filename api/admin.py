...
<body>
    ...
    <script>
        ...
        function initApp(){loadProducts();loadCategories();setupEventListeners();checkAdminAccess();updateCartDisplay();selectDeliveryOption('pickup');loadSettings();}
